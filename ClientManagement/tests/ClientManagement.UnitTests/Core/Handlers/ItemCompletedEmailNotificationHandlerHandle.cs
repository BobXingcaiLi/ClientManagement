...
using ClientManagement.Core.ProjectAggregate.Events;
using ClientManagement.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace ClientManagement.UnitTests.Core.Handlers;
