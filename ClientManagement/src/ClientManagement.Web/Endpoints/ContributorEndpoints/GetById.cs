using ClientManagement.Core.ContributorAggregate;
using ClientManagement.Core.ContributorAggregate.Specifications;
using ClientManagement.SharedKernel.Interfaces;
using FastEndpoints;

namespace ClientManagement.Web.Endpoints.ContributorEndpoints;
